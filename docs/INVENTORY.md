...
| gsd-phase-researcher.compact | Token-minimized rewrite of `gsd-phase-researcher`'s persona, served instead of the canonical file by the seam described above. | `gsd_run query agent-skills` CLI seam (non-Claude persona fallback only) | inventory only |
...
| gsd-planner.compact | Token-minimized rewrite of `gsd-planner`'s persona, served instead of the canonical file by the seam described above. | `gsd_run query agent-skills` CLI seam (non-Claude persona fallback only) | inventory only |
...
| gsd-executor.compact | Token-minimized rewrite of `gsd-executor`'s persona, served instead of the canonical file by the seam described above. | `gsd_run query agent-skills` CLI seam (non-Claude persona fallback only) | inventory only |
| gsd-plan-checker.compact | Token-minimized rewrite of `gsd-plan-checker`'s persona, served instead of the canonical file by the seam described above. | `gsd_run query agent-skills` CLI seam (non-Claude persona fallback only) | inventory only |
...
| gsd-verifier.compact | Token-minimized rewrite of `gsd-verifier`'s persona, served instead of the canonical file by the seam described above. | `gsd_run query agent-skills` CLI seam (non-Claude persona fallback only) | inventory only |
...
| gsd-debugger.compact | Token-minimized rewrite of `gsd-debugger`'s persona, served instead of the canonical file by the seam described above. | `gsd_run query agent-skills` CLI seam (non-Claude persona fallback only) | inventory only |
